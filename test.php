...
<body>
		<div class="container">
			...
			<div class="row">
				<div class="kitty-1 c-offset-5 row s5 white-bg s12xs">
					<h2 class="white vend">Her name is Roux</h2>
				</div>
			</div>
			<div class="row">
				<div class="kitty-2 row s5 white-bg s12xs">
					<h2 class="white vend">Her name is Roux</h2>
				</div>
			</div>
			<div class="row">
				<div class="kitty-3 row s3 s12xs orange-bg">
					<h2 class="white vend">She is the best kitty</h2>
				</div>
			</div>
			<div class="row">
				<div class="kitty-4 s4 s12xs blue-bg row">
