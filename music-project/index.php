...
<body>
  <div class="container">
    ...
    <div class="grand-staff">
		...
		<div class="button-section mb4 row mx2">
			<div class="button-container">
				<div class="row">
					<button class="m1 incorrect">A</button>
					<button class="m1 incorrect">B</button>
					<button class="m1 incorrect">C</button>
				</div>
				<div class="row">
					<button class="m1 incorrect">D</button>
					<button class="m1 correct">E</button>
					<button class="m1 incorrect">F</button>
					<button class="m1 incorrect">G</button>
				</div>
				<div class="chord-quality row">
					<button class="m1 incorrect">Major</button>
					<button class="m1 correct">Minor</button>
				</div>
			</div>
		</div>
  </div>
