        ...
        <div class="wide-row">
          <div class="product-card px3 pt3 pb4 sm-p5 md-p4 md-mt3 md-pr13">
            ...
            <div class="product-details c12 pl11 md-pl15">
              ...
              <h3 class="body-1 pl3">
                150<span class="colorTextGold text-bold">☆</span> item
              </h3>
              <div class="row pl1">
                <div class="icon-button heart"></div>
                <div class="icon-button add"></div>
                <div class="icon-button minus"></div>
                <div class="text-button green mt1 ml-auto mr-neg3 vcenter">Edit item</div>
              </div>
          ...
          <div class="product-card px3 pt3 pb4 sm-p5 md-p4 md-mt3 md-pr13">
            ...
            <div class="product-details c12 pl11 md-pl15">
              ...
              <div class="row">
                <div class="text-button green mt1">Edit item</div>
              </div>
              <div class="row pl1">
                <div class="icon-button heart"></div>
                <div class="icon-button add"></div>
          ...
          <div class="product-card px3 pt3 pb4 sm-p5 md-p4 md-mt3 md-pr13">
            <div class="title row no-wrap c12">
              <div class="product-img grilled-chicken-salad circle-div">
              </div>
              <div class="row c12 middle">
                <div class="row no-wrap c12 mt3 md-mt4">
                  <h2 class="title-2 pl4">
                ...
                <div class="">
                  <div class="text-button green mt1 mb3 ml2">Edit item</div>
                </div>
              </div>
            </div>
            <div class="product-details c12 pl11 md-pl15">
              ...
              <h3 class="body-1 pl3">
                200<span class="colorTextGold text-bold">☆</span> item
              </h3>
              <div class="row pl1">
                <div class="icon-button heart"></div>
                <div class="icon-button add"></div>
          ...
          <div class="product-card px3 pt3 pb4 sm-p5 md-p4 md-mt3 md-pr13">
            ...
            <div class="product-details c12 pl11 md-pl15">
              ...
              <div class="row pl1">
                ...
                <div class="icon-button add"></div>
                <div class="icon-button minus"></div>
                <div class="ghost-button mt1 ml-auto mr-neg3 vcenter">Edit item</div>
              </div>
              <div class="pl3 row no-wrap reward-message hide" id="25-reward-message">
                <p class="colorTextGreen button-text">25 Star Reward applied toward your drink customizations</p>
                <p class="button-text colorTextBlack ml-auto pl3">-25<span class="colorTextGold">☆</p>
          ...
          <div class="product-card px3 pt3 pb4 sm-p5 md-p4 md-mt3 md-pr13">
            ...
            <div class="product-details c12 pl11 md-pl15">
              ...
              <h3 class="body-1 pl3">
                50<span class="colorTextGold text-bold">☆</span> item
              </h3>
              <div class="ghost-button mt3 mb1 inline-block">Edit item</div>
              <div class="row pl1">
                <div class="icon-button heart"></div>
                <div class="icon-button add"></div>
                <div class="icon-button minus"></div>
          ...
          <div class="product-card px3 pt3 pb4 sm-p5 md-p4 md-mt3 md-pr13">
            <div class="title row no-wrap c12">
              ...
              <div class="row c12 middle">
                ...
                <div class="">
                  <div class="ghost-button mt3 mb3 ml2">Edit item</div>
                </div>
              </div>
            </div>
            <div class="product-details c12 pl11 md-pl15">
          ...
          <div class="product-card px3 pt3 pb4 sm-p5 md-p4 md-mt3 md-pr13">
            ...
            <div class="product-details c12 pl11 md-pl15">
              ...
              <h3 class="body-1 pl3">
                400<span class="colorTextGold text-bold">☆</span> item
              </h3>
              <div class="row pl1">
                <div class="icon-button heart"></div>
                <div class="icon-button add"></div>
          ...
          <div class="product-card mt2 md-my3 md-p0">
            ...
            <div class="row px2 mt2 mb3 sm-px4 sm-mb5 md-px3 md-my3">
              ...
              <div class="filled-button black toggle-reward m2" id="50-reward">
                <span class="reward-text">Use</span> 50 <span class="colorTextGold">★</span>
              </div>
              <div class="filled-button black toggle-reward m2" id="150-reward">
                <span class="reward-text">Use</span> 150 <span class="colorTextGold">★</span>
              </div>
              <div class="filled-button black toggle-reward m2" id="200-reward">
                <span class="reward-text">Use</span> 200 <span class="colorTextGold">★</span>
              </div>
